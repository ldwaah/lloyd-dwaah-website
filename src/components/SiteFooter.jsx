...
export default function SiteFooter({ minimal = false, scrubMode = false }) {
      ...
      <div className="section-pad-tight mx-auto max-w-3xl text-center">
        {scrubMode ? (
          <>
            ...
            <h2
              data-footer-heading
              className="mt-6 overflow-hidden font-serif text-hero text-ink text-balance"
            >
              {contact.heading}
            </h2>
            <p
              data-footer-text
              className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-muted"
            >
              {contact.text}
            </p>
          </>

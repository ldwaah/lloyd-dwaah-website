...
export default function Contact() {
  return (
    <section id="contact" className="section border-t border-line bg-white">
      <Reveal>
        <div className="rounded-3xl border border-line bg-canvas px-8 py-14 text-center shadow-card md:px-16 md:py-16">
